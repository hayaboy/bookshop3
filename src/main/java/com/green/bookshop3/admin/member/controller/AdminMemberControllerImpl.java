package com.green.bookshop3.admin.member.controller;
...
public class AdminMemberControllerImpl extends BaseController implements com.bookshop01.admin.member.controller.AdminMemberController {
	@Autowired
	...
	public ModelAndView adminGoodsMain(@RequestParam Map<String, String> dateMap,
		...
		System.out.println("adminMemberMain.do");
